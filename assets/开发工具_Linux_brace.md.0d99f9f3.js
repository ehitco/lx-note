import{_ as s,o as n,c as a,a as e}from"./app.aec7eb12.js";const d=JSON.parse('{"title":"brace","description":"","frontmatter":{},"headers":[],"relativePath":"\u5F00\u53D1\u5DE5\u5177/Linux/brace.md","lastUpdated":1670483514000}'),l={name:"\u5F00\u53D1\u5DE5\u5177/Linux/brace.md"},p=e(`<h1 id="brace" tabindex="-1">brace <a class="header-anchor" href="#brace" aria-hidden="true">#</a></h1><p>\u7528\u4EE5\u6269\u5C55\u96C6\u5408\u3001\u6570\u7EC4\uFF0C\u6709\u4EE5\u4E0B\u8BED\u6CD5\uFF1A</p><ul><li><code>set</code>\uFF1A<code>{a,b,c}</code></li><li><code>range</code>\uFF1A<code>{1..10}</code>\uFF0C<code>{01..10}</code></li><li><code>step</code>\uFF1A<code>{1..10..2}</code></li></ul><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">$ </span><span style="color:#82AAFF;">echo</span><span style="color:#A6ACCD;"> {a,b,c}</span></span>

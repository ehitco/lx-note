...
export const nav: DefaultTheme.Config['nav'] = [
  { text: '导航', link: '/nav', activeMatch: '^/nav' },
  {
    text: '前端物语',
    items: [
      { text: 'JavaScript 基础知识', link: '/front-end/javascript/index' },
      { text: 'ES6 常用知识', link: '/front-end/es6/' },
      { text: 'TypeScript 基础知识', link: '/front-end/typescript/base' },
      { text: '浏览器相关知识', link: '/front-end/browser/' }
    ],
